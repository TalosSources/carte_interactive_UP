...
export function SKFooter({regions} : {regions:Region[]}) {
    return <Footer className="row footer ng-scope pt-10" ng-controller="Footer">
            ...
            <div className="col-lg-2 col-md-2 col-xs-6 col-sm-3">
                ...
                <li key="links-about"><a href="https://www.smartakartan.se/om-smarta-kartan" target="_blank" className="ng-scope">About us</a></li>
                <li key="links-values"><a href="https://www.smartakartan.se/vardegrund" target="_blank" className="ng-scope">What's on the map?</a></li>
